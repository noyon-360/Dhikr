...
import 'package:dhikrs/Screens/download.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';
import 'package:dhikrs/Controller/CustomTranslationSelector.dart';
...
import 'package:dhikrs/Helper/Color.dart';
import 'package:dhikrs/ListOfAllName/Dhikrs.dart';
import 'package:dhikrs/ListOfAllName/ListOfAllNameInBangla.dart';
          ...
          actions: [
            ...
            !_searchBar
                ? Padding(
                    ...
                    child: buildTranslationSelector(
      ...
      children: [
        Row(
          ...
          children: [
            totalSelected == 0
                ? Text("Select All")
                : Text("Total Select $totalSelected"),
            Padding(
                                  ...
                                  onPressed: () {
                                    if (item is AllahName) {
                                      ...
                                      dhikrProvider.toggleDhikrSelection(
                                          item, false);
                                      dhikrProvider.removeSelectedDhikr(item);
                                    } else if (item is NameEntry) {
                                      customAddProvider.toggleSelection(
                                          item, false);
                                      customAddProvider.removeName(item);
                                    }
                                    Navigator.of(context).pop();
                                  },
                                ),
